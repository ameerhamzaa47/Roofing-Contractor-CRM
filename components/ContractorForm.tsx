...
export function ContractorForm() {
  ...
  const handleAccessCRM = () => {
    window.open('https://project-two-mu-88.vercel.app/', '_blank');
    setShowSuccessModal(false);
  };
    ...
    <>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full mx-4 relative animate-in zoom-in-95 duration-300">
            {/* Close Button */}
            <button
